    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        <div className="text-center mb-6">
          <svg className="mx-auto mb-4" viewBox="0 0 74 24" width="75" height="24">
            <g fill="none">
        ...
        <p className="text-center text-gray-600 text-sm mb-8">
          para continuar no Ledivan Plus
        </p>

        <a
          href={`/api/auth/google?action=callback&email=giselebarrossantos@gmail.com&returnTo=${encodeURIComponent(returnTo)}`}
          className="block p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
        >
          <div className="flex items-center">
            <div className="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center text-white font-medium mr-4">
              G
            </div>
            <div className="flex-1">
              <div className="font-medium text-gray-800">Gisele Barros Santos</div>
              <div className="text-sm text-gray-600">giselebarrossantos@gmail.com</div>
            </div>
          </div>
        </a>
