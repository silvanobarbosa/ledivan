...
export function DemoStarter() {
  ...
  return (
    <form ref={formRef} action={startDemo} className="text-center space-y-4">
      ...
      <p className="font-display text-xl font-bold text-primary">Preparando sua demonstração…</p>
      <p className="text-sm text-foreground/60 max-w-xs mx-auto">Montando um ambiente completo com dados de exemplo. Leva alguns segundos.</p>
